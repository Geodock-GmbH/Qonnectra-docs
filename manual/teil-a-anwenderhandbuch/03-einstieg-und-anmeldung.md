...
- Rohrzuordnung (Zuordnung der in der Rohrverwaltung angelegten Rohre zu den Trassen(Geometrien))
- Rohrverzweigung
- Mikrorohrplanung
- Netzschema
...
Oben rechts in der Kopfzeile befinden sich folgende Optionen:

- Spracheinstellungen: Deutsch (DE) oder Englisch (EN)
- Hell-/Dunkelmodus: Wenn im Hellmodus (Sonne), wird das Symbol für den Dunkelmodus (Mond) angezeigt und anders herum. 
